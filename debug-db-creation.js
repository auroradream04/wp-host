...
async function testDatabaseCreation() {
  ...
  try {
    ...
    await connection.execute(
      `GRANT ALL PRIVILEGES ON \`${testDbName}\`.* TO \`${testUser}\`@\`localhost\``,
    );
...
console.log(
  'This script tests the fix for the "database doesn\'t exist" error.\n',
);
console.log(
  "⚠️  Note: Update the MySQL root password in the script before running!\n",
);
